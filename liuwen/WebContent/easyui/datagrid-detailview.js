var detailview = $.extend({}, $.fn.datagrid.defaults.view, {
      ...
      onAfterRender  : function(target) {
        ...
        function resizeDetails() {
          ...
          // var details =
          // dc.body2.find('div.datagrid-row-detail:visible')._outerWidth(ww);
        ...
        this.canUpdateDetail = true; // define if to update the detail content
                                      // when 'updateRow' method is called;
